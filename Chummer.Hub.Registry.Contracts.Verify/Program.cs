...
VerifySealedRecord(typeof(ReleaseAuthorityArtifactProjection));
VerifySealedRecord(typeof(ReleaseAuthorityPublicationMetadata));
VerifySealedRecord(typeof(ReleaseAuthorityPublishRequest));
VerifySealedRecord(typeof(ReleaseAuthorityCurrentPointerProjection));
VerifySealedRecord(typeof(ReleaseAuthoritySnapshotProjection));
VerifySealedRecord(typeof(ReleaseAuthorityEnvelopeProjection));
