...
39. `chummer-design/products/chummer/EXTERNAL_TOOLS_PLANE.md`
40. `chummer-design/products/chummer/LTD_CAPABILITY_MAP.md`
...
112. `chummer-design/products/chummer/LTD_DISCOVERY_OUTREACH_AND_VALIDATION_INTEGRATION_GUIDE.md`
...
123. `chummer-design/products/chummer/LTD_RUNTIME_AND_PROJECTION_REGISTRY.yaml`
...
170. `chummer-design/products/chummer/CREATOR_OPERATING_SYSTEM.md`
...
`chummer-design/products/chummer/LTD_RUNTIME_AND_PROJECTION_REGISTRY.yaml` composes owned tools into governed operating systems: public growth, discovery, artifact factory, BLACK LEDGER ops, Table Pulse/companion lab, and trust/closure. It also keeps optional buys such as SendFox, Flonnect, CutMe Short, Backona AI, and Visby as watchlist candidates rather than product truth.
