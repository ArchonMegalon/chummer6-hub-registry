...
PIPELINE_DOC_SNIPPETS = (
    ...
    "| `blazor-desktop:macos:osx-arm64` | `fallback` | `proof_required` | `fallback_not_promoted` | `not_revoked` |",
...
EXPECTED_PROOF_RECEIPT_LISTS = {
    ...
    "route_truth_state_floor": [
        ...
        "blazor-desktop:windows:win-x64 fallback proof_required blocked_missing_proof fallback_not_promoted not_revoked fallback_recovery_head missing_artifact_or_startup_smoke_proof fallback_missing_artifact_or_startup_smoke_proof no_registry_revoke_marker",
        "avalonia:macos:osx-arm64 primary promoted eligible manual_recovery_required not_revoked primary_flagship_head installer_smoke_and_release_proof_passed fallback_missing_artifact_or_startup_smoke_proof no_registry_revoke_marker",
        "blazor-desktop:macos:osx-arm64 fallback proof_required blocked_missing_proof fallback_not_promoted not_revoked fallback_recovery_head missing_artifact_or_startup_smoke_proof fallback_missing_artifact_or_startup_smoke_proof no_registry_revoke_marker",
    ],
    "guardrails": [
        "scripts/verify_public_release_channel.py",
        "scripts/verify_next90_m101_registry_promotion_discipline.py",
