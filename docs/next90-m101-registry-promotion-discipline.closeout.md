...
Verified guardrail commit: a1da9ca, Tighten M101 exact route-tuple rationale proof
...
* `scripts/verify_next90_m101_registry_promotion_discipline.py` can no longer resolve the recorded verified guardrail commit `a1da9ca`,
